        ...
        <div className="col-md-5">
          <div className="card shadow-lg border-0 rounded-4">
            <div className="card-body p-5">
              ...
              <p className="text-muted text-center mb-4">Establish your professional identity</p>

              {message && (
                <div className={`alert ${message.includes('✅') ? 'alert-success' : 'alert-danger'} fade show`}>
                  {message}
                </div>
              )}
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-3">
                  ...
                  <input type="text" name="name" className="form-control form-control-lg" placeholder="e.g. Ishpreet Kaur" onChange={handleChange} required />
                </div>

                <div className="mb-3">
                  <label className="form-label fw-semibold">Email Address</label>
                  <input type="email" name="email" className="form-control form-control-lg" placeholder="name@company.com" onChange={handleChange} required />
                </div>
                ...
                {/* HIERARCHY SELECTION */}
                <div className="mb-4">
                  <label className="form-label fw-semibold text-primary">Assign Manager / Supervisor</label>
                  <select 
                    name="manager_id" 
                  ...
                  <div className="form-text">This ensures your projects are routed to the right person for approval.</div>
                </div>

                {/* ROLE SELECTION (Only visible if Admin is registering someone) */}
                {currentUserRole === 'admin' && (
                  <div className="mb-4 p-3 bg-light rounded">
                    <label className="form-label fw-bold text-danger">Admin Control: Set Role</label>
